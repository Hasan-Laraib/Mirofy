...
const MESSAGE_PAIRS = {
  ...
  'diagram.description.architecture': ['An architecture diagram generated by Mirofy.', '由 Mirofy 生成的架构图。'],
  'diagram.description.workflow': ['A workflow diagram generated by Mirofy.', '由 Mirofy 生成的工作流图。'],
  'diagram.description.sequence': ['A sequence diagram generated by Mirofy.', '由 Mirofy 生成的时序图。'],
  'diagram.description.dataflow': ['A data-flow diagram generated by Mirofy.', '由 Mirofy 生成的数据流图。'],
  'diagram.description.lifecycle': ['A lifecycle diagram generated by Mirofy.', '由 Mirofy 生成的生命周期图。'],
  ...
  'legend.architecture.module': ['Module', '模块'],
  ...
  'legend.workflow.module': ['Module', '模块'],
  ...
  'viewer.preset.badge.editorialPlate': ['MIROFY / PLATE 04', 'MIROFY / 图版 04'],
  ...
  'viewer.export.card.routeBadge': ['MIROFY · ROUTE · {hops}', 'MIROFY · 路径 · {hops}'],
  'viewer.export.card.reachBadge': ['MIROFY · {direction} REACH', 'MIROFY · {direction}可达范围'],
  'viewer.export.card.defaultBadge': ['MIROFY · {preset} · {theme}', 'MIROFY · {preset} · {theme}'],
...
for (const [key, messages] of Object.entries(MESSAGE_PAIRS)) {
  if (messages.length !== SUPPORTED_LOCALES.length || messages.some((message) => typeof message !== 'string')) {
    throw new Error(`Incomplete Mirofy i18n tuple ${JSON.stringify(key)}`);
  }
}
...
export function translateMessage(locale, key, values = {}) {
  ...
  if (!Object.hasOwn(CATALOGS[resolved], key)) {
    throw new Error(`Missing Mirofy i18n message ${JSON.stringify(key)} for ${resolved}`);
  }
