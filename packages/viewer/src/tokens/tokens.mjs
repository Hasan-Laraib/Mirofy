...
const RAW_BLOCKS = [
  ...
  },
  {
    ...
    body: "      --bg: #f8fafc;\n      --grid: #e2e8f0;\n      --panel: #ffffff;\n      --panel-border: #e2e8f0;\n      --lane-fill: rgba(248, 250, 252, 0.65);\n      --lane-stroke: #cbd5e1;\n      --text: #0f172a;\n      --text-muted: #64748b;\n      --text-dim: #94a3b8;\n      --text-faint: #64748b;\n      --mask: #ffffff;\n      --frontend-fill: rgba(86, 180, 233, 0.15);\n      --frontend-stroke: #1c658e;\n      --backend-fill: rgba(0, 158, 115, 0.18);\n      --backend-stroke: #078664;\n      --database-fill: rgba(204, 121, 167, 0.2);\n      --database-stroke: #a13872;\n      --cloud-fill: rgba(230, 159, 0, 0.18);\n      --cloud-stroke: #7c5706;\n      --security-fill: rgba(213, 94, 0, 0.15);\n      --security-stroke: #be5908;\n      --messagebus-fill: rgba(240, 228, 66, 0.15);\n      --messagebus-stroke: #514b05;\n      --external-fill: rgba(0, 114, 178, 0.18);\n      --external-stroke: #0072b2;\n      --arrow: #94a3b8;\n      --arrow-emphasis: #059669;\n      --toolbar-bg: rgba(255, 255, 255, 0.92);\n      --toolbar-border: #cbd5e1;\n      --toolbar-text: #334155;\n      --toolbar-hover: #ffffff;\n      --toolbar-menu-bg: #ffffff;\n",
  },
  {
    prefix: "\n\n    /* ==========================================================\n       MERIDIAN — an editorial preset for documentation.\n       Near-neutral ground, low-chroma fills, darker light-mode strokes,\n       and GRAPHITE arrows: relationships read as structure, and colour\n       is reserved for what a node is. ADDED, never substituted — every\n       existing preset still renders byte-for-byte as before.\n       ========================================================== */\n",
    selector: "    [data-preset=\"meridian\"][data-theme=\"dark\"] ",
    body: "\n      --bg: #0d1117;\n      --grid: #1c2430;\n      --text: #e9eef5;\n      --text-muted: #9aa7b6;\n      --text-dim: #67727f;\n      --text-faint: #7e8a97;\n      --panel: rgba(15, 20, 27, 0.94);\n      --panel-border: #2b3440;\n      --lane-fill: rgba(22, 28, 36, 0.5);\n      --lane-stroke: #333d4b;\n      --arrow: #7d8794;\n      --arrow-emphasis: #6cb6ff;\n      --mask: #0d1117;\n      --frontend-fill: rgba(88, 166, 255, 0.10);\n      --frontend-stroke: #6cb6ff;\n      --backend-fill: rgba(63, 185, 80, 0.10);\n      --backend-stroke: #57cc6a;\n      --database-fill: rgba(163, 113, 247, 0.10);\n      --database-stroke: #b487ff;\n      --cloud-fill: rgba(210, 153, 34, 0.10);\n      --cloud-stroke: #e3b341;\n      --security-fill: rgba(248, 81, 73, 0.10);\n      --security-stroke: #ff7b72;\n      --messagebus-fill: rgba(219, 109, 40, 0.10);\n      --messagebus-stroke: #f0883e;\n      --external-fill: rgba(110, 118, 129, 0.16);\n      --external-stroke: #9aa5b1;\n      --toolbar-bg: rgba(15, 20, 27, 0.94);\n      --toolbar-border: #2b3440;\n      --toolbar-text: #e9eef5;\n      --toolbar-hover: rgba(33, 41, 52, 0.96);\n      --toolbar-menu-bg: #111720;\n    ",
  },
  {
    prefix: "\n\n",
    selector: "    [data-preset=\"meridian\"][data-theme=\"light\"] ",
    body: "\n      --bg: #ffffff;\n      --grid: #e8ebef;\n      --text: #1b1f24;\n      --text-muted: #4d5763;\n      --text-dim: #79828d;\n      --text-faint: #616b76;\n      --panel: #ffffff;\n      --panel-border: #d3d9e0;\n      --lane-fill: rgba(246, 248, 250, 0.75);\n      --lane-stroke: #cfd6dd;\n      --arrow: #5c6672;\n      --arrow-emphasis: #0757ba;\n      --mask: #ffffff;\n      --frontend-fill: rgba(9, 105, 218, 0.07);\n      --frontend-stroke: #0757ba;\n      --backend-fill: rgba(26, 127, 55, 0.07);\n      --backend-stroke: #166b2e;\n      --database-fill: rgba(130, 80, 223, 0.07);\n      --database-stroke: #6b3fbe;\n      --cloud-fill: rgba(154, 103, 0, 0.08);\n      --cloud-stroke: #7d5400;\n      --security-fill: rgba(207, 34, 46, 0.07);\n      --security-stroke: #ab1c26;\n      --messagebus-fill: rgba(191, 87, 0, 0.07);\n      --messagebus-stroke: #9c3f00;\n      --external-fill: rgba(110, 118, 129, 0.10);\n      --external-stroke: #5c6672;\n      --toolbar-bg: rgba(255, 255, 255, 0.95);\n      --toolbar-border: #d3d9e0;\n      --toolbar-text: #1b1f24;\n      --toolbar-hover: rgba(236, 240, 244, 0.98);\n      --toolbar-menu-bg: #ffffff;\n    ",
  },
];
